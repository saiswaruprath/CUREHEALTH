  ...
  return (
    ...
    <div className="row g-3 mb-3">
        <div className="form-floating col">
          <input type="text" className="form-control" id="formGroupResourceTopic" placeholder="Enter Resource Topic" aria-label="Resource Topic" name="topic"
          value={resourceData.topic} onChange={handleInputChange}/>
          <label htmlFor="formGroupResourceTopic" className="">Resource Topic</label>
        </div>
        <div className="form-floating col">
          <input type="text" className="form-control" id="formGroupResourceType" placeholder="Enter Resource Type" aria-label="Resource Type" name="type" value={resourceData.type}onChange={handleInputChange}/>
          <label htmlFor="formGroupResourceType" className="">Resource Type</label>
        </div>
      </div>
      <div className="form-floating col-12 mb-3">
        <input type="text" className="form-control" id="formGroupSubject" placeholder="Enter Subject Here" name="subject" value={resourceData.subject} onChange={handleInputChange}/>
        <label htmlFor="formGroupSubject" className="">Subject</label>
      </div>
      <div className="form-floating col-12 mb-3">
        <textarea className="min-height--75 form-control" id="formGroupContent" placeholder="Enter Content Here" name="content" value={resourceData.content} onChange={handleInputChange} />
        <label htmlFor="formGroupContent" className="form-label">Content</label>
      </div>
      <div className="form-floating col-12 mb-3">
        <input type="text" className="form-control" id="formGroupUser" placeholder="Enter User ID Here" name="userid" value={resourceData.userid} onChange={handleInputChange}/>
        <label htmlFor="formGroupUser" className="">User ID / Email</label>
      </div>

      <InputGroup size="lg" className='mt-2 mb-3'>
        <InputGroup.Text id="search-input-group"><i className="bi bi-upload"></i></InputGroup.Text>
        <Form.Control
        ...
        />
        <Button variant="outline-primary" id="upload-image-button" className='z-0' onClick={(e) => imageUploadBtn.current?.click()}><i className="far fa-image"></i> Images</Button>
        <Button variant="outline-primary" id="upload-pdf-button" className='z-0' onClick={(e) => pdfUploadBtn.current?.click()}><i className="far fa-file-alt"></i> PDF's</Button>
        <Button variant="outline-primary" id="upload-video-button" className='z-0' onClick={(e) => videoUploadBtn.current?.click()}><i className="far fa-file-video"></i> Videos</Button>
        <Button variant="outline-primary" id="upload-doc-button" className='z-0' onClick={(e) => documentUploadBtn.current?.click()}><i className="far fa-file"></i> Documents</Button>
      </InputGroup>

      <div className="form-floating col-12 mb-4">
        <textarea className="form-control" id="formGroupUrl" placeholder="Enter URL Here" name="url" onChange={(e) => handleFileChange(e, "urls")} />
        <label htmlFor="formGroupContent" className="form-label">URL's (multiple URL's to separated by commas)</label>
      </div>        
    ...
    <label htmlFor="urlInput" className="file-type-icon">
      ...
      <div className="uploaded-files">
        { uploadedFiles.length != 0 && <><h4>Uploaded Files:</h4></>}
        <ul>
      ...
      <Stack className='mt-4' direction="horizontal" gap={3}>
        <Button size="lg" variant="primary ms-auto" onClick={handleSubmit}>Publish</Button>
        <Button size="lg" variant="primary " onClick={handleClear}>Clear</Button>
      </Stack>
